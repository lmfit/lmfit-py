...
if __name__ == '__main__':
    ...
    test_height_fwhm(x, y, lineshapes.damped_oscillator, models.DampedOscillatorModel())
    test_height_fwhm(x, y, lineshapes.dho, models.DampedHarmonicOscillatorModel())
    test_height_fwhm(x, y, lineshapes.expgaussian, models.ExponentialGaussianModel())
    test_height_fwhm(x, y, lineshapes.skewed_gaussian, models.SkewedGaussianModel())
    test_height_fwhm(x, y, lineshapes.donaich, models.DonaichModel())
    x=x-9 # Lognormal will only fit peaks with centers < 1
    test_height_fwhm(x, y, lineshapes.lognormal, models.LognormalModel())
