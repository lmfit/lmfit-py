...
FROM_PY = ('ArithmeticError', 'AssertionError', 'AttributeError',
           ...
           'buffer', 'bytearray', 'bytes', 'chr', 'cmp', 'coerce',
           'complex', 'delattr', 'dict', 'dir', 'divmod', 'enumerate',
           'file', 'filter', 'float', 'format', 'frozenset', 'getattr',
           'hasattr', 'hash', 'hex', 'id', 'int', 'isinstance', 'len',
           'list', 'map', 'max', 'min', 'oct', 'open', 'ord', 'pow',
           'property', 'range', 'raw_input', 'reduce', 'repr', 'reversed',
           'round', 'set', 'setattr', 'slice', 'sorted', 'str', 'sum',
           'tuple', 'type', 'unichr', 'unicode', 'zip')
...
FROM_NUMPY = ('ComplexWarning', 'Inf', 'NAN', 'abs', 'absolute', 'add',
              ...
              'blackman', 'bmat', 'bool', 'bool8', 'broadcast',
              ...
              'select', 'setbufsize', 'setdiff1d', 'seterr', 'setmember1d',
              'setxor1d', 'shape', 'short', 'sign', 'signbit',
