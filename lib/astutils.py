...
FROM_NUMPY = ('Inf', 'NAN', 'abs', 'absolute', 'add', 'alen', 'all',
              ...
              'generic', 'genfromtxt', 'getbuffer', 'getbufsize', 'geterr',
              ...
              'string0', 'string_', 'subtract', 'sum', 'swapaxes', 'take',
              'tan', 'tanh', 'tensordot', 'test', 'testing', 'tile',
              'trace', 'transpose', 'trapz', 'tri', 'tril', 'tril_indices',
